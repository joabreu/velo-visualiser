...
- **40+ audio and beat reactive visualizers**: Waveforms, spectra, particle fluids, scrolling spectrograms, dot-matrix LED meters, twin true-stereo XY oscilloscopes (including a phosphor CRT scope for oscilloscope music), and more.
